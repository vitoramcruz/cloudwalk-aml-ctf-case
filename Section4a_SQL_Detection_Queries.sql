-- ============================================================================
-- Candidate: Vitor Cruz
-- Submission date: 2026-08-24
-- Target role: AML/CTF Analyst (US) — CloudWalk Payments Inc.
-- This file is part of the CloudWalk AML/CTF technical case submission.
-- See MANIFEST_AND_SIGNATURES.pdf (package root) for the SHA-256 checksum
-- and digital signature covering this file.
-- ============================================================================
...
--      the chargeback outlier merchant sits at ~12% vs. a ~0.73% baseline;
...
-- exceeds the risk threshold. Dataset baseline is ~0.73%; the confirmed
...
-- CHARGEBACK_RATIO_AUTO_SUSPEND  | M3030       | ElectroHub #330    | 366             | 44               | 0.1202

-- Parameter reference table
-- parameter        | default | regulatory rationale
-- alert_threshold   | 0.05    | Set well above the dataset's ~0.73% confirmed baseline; a merchant sustaining >5% chargebacks is a recognized card-network/BSA risk indicator (see Program Update §4 tiering: 3% yellow / 5% red / 8–10% auto-suspend)
